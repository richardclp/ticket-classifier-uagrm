...
with st.container():  # Use a container to separate from form
...
with st.form("add_ticket_form"):
    ...
    # Lógica de envío del formulario aquí (si es aplicable)
    if submitted:
        # Procesar los datos del formulario (issue, priority)
        pass
